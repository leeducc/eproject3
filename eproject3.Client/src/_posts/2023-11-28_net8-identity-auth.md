...
[Configure.Auth.cs](https://github.com/NetCoreTemplates/blazor/blob/main/eproject3/Configure.Auth.cs):
...
[CustomUserSession.cs](https://github.com/NetCoreTemplates/blazor/blob/main/eproject3.ServiceInterface/Data/CustomUserSession.cs), e.g:
...
for a new Blazor Project from its [Program.cs](https://github.com/NetCoreTemplates/blazor/blob/main/eproject3/Program.cs):
...
configuration in its [Program.cs](https://github.com/NetCoreTemplates/mvc/blob/main/eproject3/Program.cs) which will 
also require adding the NuGet dependencies of the OAuth providers you want to support which you can get from its
[eproject3.csproj](https://github.com/NetCoreTemplates/mvc/blob/main/eproject3/eproject3.csproj)
...
UI Pages are in the 
[Components/Identity](https://github.com/NetCoreTemplates/blazor/tree/main/eproject3/Components/Identity) and 
[Pages/Account](https://github.com/NetCoreTemplates/blazor/tree/main/eproject3/Components/Pages/Account) folders.

For MVC, most of the Identity UI are in the 
[Account](https://github.com/NetCoreTemplates/mvc/blob/main/eproject3/Controllers/AccountController.cs)
and [Manage](https://github.com/NetCoreTemplates/mvc/blob/main/eproject3/Controllers/ManageController.cs) controllers
as well as their
[Views/Account](https://github.com/NetCoreTemplates/mvc/tree/main/eproject3/Views/Account) and
[Views/Manage](https://github.com/NetCoreTemplates/mvc/tree/main/eproject3/Views/Manage) folders.
...
[Configure.Mq.cs](https://github.com/NetCoreTemplates/blazor/blob/main/eproject3/Configure.Mq.cs)
which uses it to invoke the `SendEmail` API in 
[EmailServices](https://github.com/NetCoreTemplates/blazor/blob/main/eproject3.ServiceInterface/EmailServices.cs) in a 
