        ...
        <Layout>
            ...
            <div className="container px-5 mb-32 mx-auto">
                <article className="mt-20">
                            ...
                            <div className="mb-4 flex flex-wrap">
                                {post.tags.map(tag => (
                                    <Link
                                        key={tag}
                                        to={tagLink(tag)}
                                        className="mr-2 mb-2 text-xs font-semibold bg-slate-400/10 dark:bg-slate-400/30 rounded-full py-1 px-3 hover:bg-slate-400/20"
                                    >
                                        {tag}
                                    </Link>
                                ))}
                    ...
                    {/* Markdown Content */}
                    <div className="prose dark:prose-invert lg:prose-xl max-w-none mb-32">
                        <MarkdownComponent
                            type="blog"
                            doc={{
                                slug:           post.slug,
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            {relatedPosts.map(p => (
                                <div key={p.slug} className="flex flex-col overflow-hidden">
                                    ...
                                    <div className="flex flex-col justify-between bg-white dark:bg-black p-6">
                                        <div>
